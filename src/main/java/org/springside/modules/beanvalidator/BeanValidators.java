...
public class BeanValidators {
	...
	public static List<String> extractMessage(
			@SuppressWarnings("rawtypes") Set<? extends ConstraintViolation> constraintViolations) {
	 ...
	 */
	public static List<String> extractPropertyAndMessageAsList(
			@SuppressWarnings("rawtypes") Set<? extends ConstraintViolation> constraintViolations, String separator) {
		List<String> errorMessages = Lists.newArrayList();
		for (@SuppressWarnings("rawtypes")
		ConstraintViolation violation : constraintViolations) {
